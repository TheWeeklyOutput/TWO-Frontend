...
<style>
    ...
    @media (min-width: 880px) {
        ...
        .style-3 .article-heading-filler .page-views-text {
            display: table;
        ...
        .style-3 .article-heading-filler .page-views-number {
            font-size: 4em;
        }
        .style-3 .article-heading-filler .page-views-container {
            position: relative;
            padding: 10px 0
        }
    ...
    @media only screen and (max-width: 880px) {
        ...
        .style-3 .article-heading:before {
            content: "";
            display: inline-block;
            position: absolute;
            width: 40px;
        ...
        .style-3 .article-component .page-views-container {
            position: absolute;
            bottom: 0;
            padding: 20px;
            left: 20px
